...
char * prepare_syn(const char *src_ip, const char *src_port, const char *dst_ip, const char *dst_port, const unsigned len)
{
    ...
    fprintf(cfg, trafgen_syn_cfg.c_str(), 40+len, src_ip, dst_ip, src_port, dst_port, len);
    fclose(cfg);
}
...
char * prepare_rst(const char *src_ip, const char *src_port, const char *dst_ip, const char *dst_port, const unsigned len)
{
    ...
    fprintf(cfg, trafgen_rst_cfg.c_str(), 40+len, src_ip, dst_ip, src_port, dst_port, len);
    fclose(cfg);
}
...
char * prepare_udp(const char *src_ip, const char *src_port, const char *dst_ip, const char *dst_port, const unsigned len)
{
    ...
    fprintf(cfg, trafgen_udp_cfg.c_str(), 28+len, src_ip, dst_ip, src_port, dst_port, 8+len, len);
    fclose(cfg);
...
char * prepare_icmp(const char *src_ip, const char *dst_ip, const unsigned len)
{
    ...
    fprintf(cfg, trafgen_icmp_cfg.c_str(), 28+len, src_ip, dst_ip, 42+len, len);
    fclose(cfg);
...
char * prepare_arp(const char *src_ip, const char *dst_ip, const unsigned len)
{
    ...
    fprintf(cfg, trafgen_arp_cfg.c_str(), src_ip, dst_ip, len);
    fclose(cfg);
...
char * prepare_dns(const char *src_ip, const char *src_port, const char *dst_ip,  const unsigned len, const char *dns_name)
{
    ...
    fprintf(cfg, trafgen_dns_cfg.c_str(), 45+strlen(dns_name)+len, src_ip, dst_ip, src_port, 25+strlen(dns_name)+len, dns_buf, len);
    fclose(cfg);
...
char * prepare_dhcp(const unsigned len)
{
    ...
    fprintf(cfg, trafgen_dhcp_cfg.c_str(), 272+len, 252+len, len);
    fclose(cfg);
...
char * prepare_ssdp(const char * src_ip, const char *dst_ip, const unsigned len){
    ...
    fprintf(cfg, trafgen_ssdp_cfg.c_str(), src_ip, dst_ip);
    fclose(cfg);
}
